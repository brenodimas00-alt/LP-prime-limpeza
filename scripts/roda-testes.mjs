...
const HOMOLOG = ['testa-rls', 'testa-auth', 'testa-importacao', 'testa-paridade', 'testa-b3', 'testa-b5', 'testa-b6', 'testa-b0-preview', 'testa-b2-preview', 'testa-f2-preview', 'testa-i1-preview'];
const NODE = [

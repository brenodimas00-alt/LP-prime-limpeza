...
const STATUS_ERRO = {
  DADOS_INVALIDOS: 400, EVENTO_INVALIDO: 400, DATA_INVALIDA: 422, REGIAO_NAO_ATENDIDA: 422, NAO_ENCONTRADO: 404,
...
export function criarFakeApi({ agoraFixo, urlSite = 'http://localhost:8080/LP-prime-limpeza/', configPrime = () => PRIME_TESTE } = {}) {
  ...
  const rotas = [
    ...
    ['POST', /^\/pagamentos$/, (c) => casos.criarPagamento(c.corpo, c.o), 201],

...
export const ARIDADE = {
  ...
  listarAtendimentos: 1, listarAtendimentosDaDiarista: 1, listarAvaliacoes: 1, buscarClientePorTelefone: 1, buscarDiaristaPorEmail: 1, verificarCredencial: 1, existeCredencial: 1,
};

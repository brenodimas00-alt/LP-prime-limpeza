-- B6: registrar_documento tinha variáveis PL/pgSQL com nome de coluna (tipo, mime): 42702 "column reference is ambiguous".
-- Mesma classe do bug do B3 (cadastrar_diarista). Variáveis com prefixo v_.
